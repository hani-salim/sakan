          ...
          child: Column(
            ...
            children: [
             ...
             const SizedBox(height: 20,),
              OutlinedButton(onPressed: (){}, child: const Text('تسجيل الخروج',style: TextStyle(color: Colors.white),),)
            ],
          ),
        ),
      )),
...
class MenuItems {
  ...
  static const settings = MenuEntities(icon: Icons.settings, title: "الإعدادات");
